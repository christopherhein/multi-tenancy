...
import (
	...
	tenancycontroller "sigs.k8s.io/multi-tenancy/tenant/controllers/tenancy"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "4bc9f11f.multi-tenancy.x-k8s.io",
	})
	if err != nil {
	...
	if err = (&tenancycontroller.TenantNamespaceReconciler{
		Client: mgr.GetClient(),
